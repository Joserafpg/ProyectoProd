...
import 'registrodeproduccionpersonalizado_model.dart';
export 'registrodeproduccionpersonalizado_model.dart';

class RegistrodeproduccionpersonalizadoWidget extends StatefulWidget {
  const RegistrodeproduccionpersonalizadoWidget({super.key});

  @override
  State<RegistrodeproduccionpersonalizadoWidget> createState() =>
      _RegistrodeproduccionpersonalizadoWidgetState();
}

class _RegistrodeproduccionpersonalizadoWidgetState
    extends State<RegistrodeproduccionpersonalizadoWidget> {
  late RegistrodeproduccionpersonalizadoModel _model;
  ...
  void initState() {
    super.initState();
    _model =
        createModel(context, () => RegistrodeproduccionpersonalizadoModel());
